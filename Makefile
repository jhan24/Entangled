...
OFILES = mylib.o main.o playerlarge.o title.o font.o smaller.o victory.o gameover.o gameplay.o countryside.o spiderdance.o glamour.o meteor.o story.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h playerlarge.h title.h font.h smaller.h victory.h gameover.h gameplay.h countryside.h spiderdance.h glamour.h meteor.h story.h
