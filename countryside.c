/*
 * countryside
 * Exported from countryside.gbt by GBA Tracker
 * Sun Nov 08 19:29:16 EST 2015
 */
...
#define BPM_QUAN_TRANSFORM -(0x14000/120)
...
static void countryside_step();
static const note_t sound_data[44];
static int index, wait;

// Begin playing the music
void countryside_play() {

	REG_IME = 0;
	REG_ISR_MAIN = countryside_step;
	REG_IE = IRQ_TIMER(0);
...
// Note data
static const note_t sound_data[44] = {
	{0x0008,0xA780,0x860C,0xF780,0x873A,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8673,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86B2,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86C5,0xF580,0x8706,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x8721,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86C5,0xF580,0x8745,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x860C,0xF580,0x873A,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8673,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86B2,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86C5,0xF580,0x8706,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x8721,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86C5,0xF580,0x8745,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x85AD,0xF580,0x873A,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8673,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8706,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86E7,0xF580,0x876C,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x8759,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8642,0xF580,0x873A,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8512,0xF780,0x8706,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x860C,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86B2,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8745,0xF780,0x8706,0x0000,0x0000,0x0030},
	{0x0008,0xA780,0x84E5,0xF780,0x8759,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x85EE,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8642,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8512,0xF580,0x8759,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x876C,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x8706,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x84E5,0xF780,0x8759,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x85EE,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8642,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8512,0xF580,0x8759,0x0000,0x0000,0x0010},
	...
	{0x0008,0xA780,0x8512,0xF580,0x8759,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x876C,0x0000,0x0000,0x0010},
	{0x0000,0x0000,0x0000,0xF580,0x873A,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8564,0xF780,0x8721,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x85EE,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x8642,0x0000,0x0000,0x0000,0x0000,0x0010},
	{0x0008,0xA780,0x86B2,0xF780,0x8642,0x0000,0x0000,0x0030}
};
